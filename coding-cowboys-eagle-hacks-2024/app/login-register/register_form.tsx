  ...
  return (
    ...
    <div className="bg-gray-900 lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl m-4">
      <form className="p-12 md:p-24" onSubmit={handleSubmit}>
        <p className='text-5xl m-3 text-gray-200'>Create an Account</p>
        ...
        <button className="bg-gradient-to-b from-gray-700 to-gray-500 font-medium p-2 md:p-4 text-white uppercase w-full rounded">Sign Up</button>
      </form>
    </div>
